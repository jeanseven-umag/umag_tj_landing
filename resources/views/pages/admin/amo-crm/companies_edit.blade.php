        ...
        <div class="top-wrap">
            <form action="{{ route('kontakty.store')}}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" value="{{$company->name}}" class="form-control" id="exampleFormControlInput1" placeholder="Введите название" required>
                </div>

                <div class="form-group">
                    <label for="exampleFormControlInput2">Адрес:*</label>
                    <input name="address" value="{{$company->address}}" type="text" class="form-control" id="exampleFormControlInput2" placeholder="Введите адрес" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="4" {{$company->status == 4 ? 'selected' : ''}}>Нету</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="exampleFormControlInput4">Телефон:*</label>
                    <input name="phone" value="{{$company->phone}}" type="text" class="form-control" id="exampleFormControlInput4" placeholder="Введите телефон" required>
                </div>
