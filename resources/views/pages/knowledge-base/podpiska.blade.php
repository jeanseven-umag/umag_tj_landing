...
<style>li.base-menu.active-menu-5{background: #fff}</style>
...
<div class="top-header-container">
  ...
  <h1 class="base-category">Обуна</h1>
  <h3 class="base-platform">@lang('knowledge-base.choose_platform')</h3>
  <div class="tabs_platform">
    <div class="tabs_platform__nav">
      <button class="tabs_platform__nav-btn" type="button" data-tab="#tab_platform_1">Вебсайт</button>
      <button class="tabs_platform__nav-btn" type="button" data-tab="#tab_platform_2">Платформаи IOS</button>
{{--      <button class="tabs_platform__nav-btn" type="button" data-tab="#tab_platform_3">Платформаи Android</button>--}}
    </div>
...
{{--            <button class="underTabs_platform__nav-btn" type="button" data-tab="#underTab_platformWeb_3">Дарсҳои видеоӣ</button>--}}
          ...
          <div class="underTabs_platform__content">
            <div class="underTabs_platform__item" id="underTab_platformWeb_1">
              @foreach($faqs as $el_faqs)
                @if($el_faqs->category_id === 5 and $el_faqs->platform_id === 1)
                  <div class="accordion">
            ...
            <div class="underTabs_platform__item" id="underTab_platformWeb_2">
              <ul class="instruction_list">
                @foreach($posts as $el_posts)
                  @if($el_posts->category_id === 5 and $el_posts->platform_id === 1 )
            ...
            <div class="underTabs_platform__item" id="underTab_platformWeb_3">
              <div class="video_list">
                @foreach($videos as $el_videos)
                  @if($el_videos->category_id === 5 and $el_videos->platform_id === 1 )
      ...
      <div class="tabs_platform__item" id="tab_platform_2">
        <div class="underTabs_platform">
          <div class="underTabs_platform__nav">
{{--            <button class="underTabs_platform__nav-btn" type="button" data-tab="#underTab_platformIOS_1">Саволҳо-ҷавобҳо</button>--}}
...
{{--            <button class="underTabs_platform__nav-btn" type="button" data-tab="#underTab_platformIOS_3">Дарсҳои видеоӣ</button>--}}
          </div>
          <div class="underTabs_platform__content">
            <div class="underTabs_platform__item" id="underTab_platformIOS_1">
              @foreach($faqs as $el_faqs)
                @if($el_faqs->category_id === 5 and $el_faqs->platform_id === 2 )
                  <div class="accordion">
                    <div class="accordion-item">
                      <div class="accordion-item__btn">{{ $el_faqs->question }}</div>
                      <div class="accordion-item__body"><div class="accordion-item__body__content">{{ $el_faqs->answer }}</div></div>
            ...
            <div class="underTabs_platform__item" id="underTab_platformIOS_2">
              <ul class="instruction_list">
                @foreach($posts as $el_posts)
                  @if($el_posts->category_id === 5 and $el_posts->platform_id === 2 )
            ...
            <div class="underTabs_platform__item" id="underTab_platformIOS_3">
              <div class="video_list">
                @foreach($videos as $el_videos)
                  @if($el_videos->category_id === 5 and $el_videos->platform_id === 2 )
                    <div class="video_list__item">
                      <iframe width="362" height="224" src="{{ $el_videos->url }}" frameborder="0" allowfullscreen></iframe>
                      <h2 class="video_list__name">{{ $el_videos->title }}</h2>
                    </div>
        ...
        <div class="underTabs_platform">
          ...
          <div class="underTabs_platform__content">
            <div class="underTabs_platform__item" id="underTab_platformAndroid_1">
              @foreach($faqs as $el_faqs)
                @if($el_faqs->category_id === 5 and $el_faqs->platform_id === 3 )
                  <div class="accordion">
                    <div class="accordion-item">
                      <div class="accordion-item__btn">{{ $el_faqs->question }}</div>
                      <div class="accordion-item__body"><div class="accordion-item__body__content">{{ $el_faqs->answer }}</div></div>
            ...
            <div class="underTabs_platform__item" id="underTab_platformAndroid_2">
              <ul class="instruction_list">
                @foreach($posts as $el_posts)
                  @if($el_posts->category_id === 5 and $el_posts->platform_id === 3 )
            ...
            <div class="underTabs_platform__item" id="underTab_platformAndroid_3">
              <div class="video_list">
                @foreach($videos as $el_videos)
                  @if($el_videos->category_id === 5 and $el_videos->platform_id === 3 )
                    <div class="video_list__item">
                      <iframe width="362" height="224" src="{{ $el_videos->url }}" frameborder="0" allowfullscreen></iframe>
                      <h2 class="video_list__name">{{ $el_videos->title }}</h2>
                    </div>
