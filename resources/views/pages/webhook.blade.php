    ...
    $json = '{
        "leads": {
            "status": [
                {
                    "id": "33278165",
                    "name": "Ариза барои дастрасии намоишӣ (Заявка на демо-доступ)",
                    "status_id": "16198420",
                    ...
                    "custom_fields": [
                        {
                            ...
                            "values": [
                                {
                                    "value": "Ариза аз вебсайт(Заявка с сайта)",
                                    "enum": "4693273"
                                }
                            ]
                        },
                        {
                            "id": "2002717",
                            "name": "Дархост аз куҷо омад?",
                            "values": [
                                {
                                    "value": "Боздиди мустақим",
                                    "enum": "4750877"
                                }
                            ]
                        },
