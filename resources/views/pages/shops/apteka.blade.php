...
@section('topheader')
    <div class="top-header-container">
        <div class="top-wrap">
            <div class="top-left">
                <h3 class="informer-title">@lang('product_automation.title_pharmacy')</h3>
                <h1 class="full-text">@lang('product_automation.description_pharmacy')</h1>
                <a href="/request-form" class="green-request">@lang('product_automation.try_free')</a>
            </div>
            <div class="top-right">
                <img src="/img/apteka.svg" alt="ҷадвали барномаи umag">
                <style>
                    li.for-active.for-active-4{background: #e4e4e4}
        ...
        <div class="bottom-wrap">
            <div class="col__one">
                <h4 class="col-title">@lang('product_automation.pharmacy_reserves')</h4>
                <p>@lang('product_automation.pharmacy_reserves_description')</p>
                <span class="play_col first-vid" data-video="USLcEnA89iE"> <i class="play_button"></i> @lang('product_automation.see_works')</span>
            </div>      
            <div class="col__two">
...
@endsection
@section('review')
<p>@lang('product_automation.review_info_pharmacy')</p>
<p>Жанна Ефимова <br/>Дорухона дар Семей</p>
@endsection
@section('iframe')
    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/1WLxU35ayjM" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
@endsection