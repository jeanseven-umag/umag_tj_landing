...
@section('topheader')
    <div class="top-header-container">
        <div class="top-wrap">
            <div class="top-left">
                <h3 class="informer-title">@lang('product_automation.title_clothing')</h3>
                <h1 class="full-text">@lang('product_automation.description_clothing')</h1>
            ...
            <div class="top-right">
                ...
                <style>
                    ...
                    @media(max-width: 767px){.top-right img {height: 31rem!important; margin-top: 25px; margin-bottom: 25px; position: relative}}
                </style>
            </div>
        </div>
