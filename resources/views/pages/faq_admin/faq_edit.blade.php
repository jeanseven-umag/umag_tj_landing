    ...
    <div class="top-wrap">
        <form action="{{ route('faq_admin.store')}}" method="POST">
            ...
            <div class="form-group">
                <label for="QuestionLabel">Вопрос*</label>
                <input name="question" type="text" value="{{$faq->question}}" class="form-control @error('question') is-invalid @enderror" id="QuestionLabel" placeholder="Введите вопрос" required>
            </div>
            <div class="form-group">
                <label for="AnswerLabel">Ответ*</label>
                <input name="answer" type="text" value="{{$faq->answer}}" class="form-control @error('answer') is-invalid @enderror" id="AnswerLabel" placeholder="Введите ответ" required>
            </div>
            <div class="form-group">
