        ...
        <div class="container sides-padding-40">
            <div class="row col-50 col-mob-100">
                <h1 class="product__title">
                    <span>Терминали ҷамъоварии маълумот</span> Honeywell EDA50
                </h1>
                <div class="product__mob-image no-desk">
                    <span class="product__mob-discount">-9%</span>
                </div>
                <p class="product__description">
                    Терминали ҷамъоварии маълумот – компютери мобилии насли нав, ки дар асоси ОС Android таҳия шудааст.
                    Дастгоҳ барои иҷрои вазифаҳо, ба монанди ревизия, инвентаризатсия, қабул ва идоракунии захираҳои анбор, хеле мувофиқ аст.
                </p>
                ...
                <div class="row row_middle product__bottom">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="button" class="button-product-buy" data-open-modal="#equipment-modal" data-type="PRODUCT_0009"
                                data-caption="Хариди мол: Терминали ҷамъоварии маълумот Honeywell EDA50">Харидан</button>
                    </div>
                </div>
            </div>
        </div>
...
@section('table')
    <table>
        ...
        <tr><td>Экран</td><td>Рангӣ, тачскрин, HD(1280 × 720)</td></tr>
        <tr><td>Сканер</td><td>1D, 2D , HI2D Imager</td></tr>
        <tr><td>Дастгирӣ</td><td>Wi-fi, Bluetouth</td></tr>
        <tr><td>Батарея</td><td>Li-Ion, 3.8V, 4000mAh</td></tr>
        <tr><td>RAM / ROM</td><td>2 ГБ / 8 ГБ</td></tr>
        <tr><td>Вақти кор</td><td>12 соат</td></tr>
        <tr><th colspan="2">Андозаҳо</th></tr>
        <tr><td>Андозаҳо</td><td>164 x 73 x 24,5 мм</td></tr>
        <tr><td>Вазн</td><td>300 г</td></tr>
    </table>
@endsection
