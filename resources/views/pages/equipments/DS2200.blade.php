    ...
    <div class="container sides-padding-40">
        <div class="row col-50 col-mob-100">
            <h1 class="product__title">
                <span>Сканер штрих-кодов</span> ZEBRA DS2200
            </h1>
            <div class="product__mob-image no-desk"></div>
            <p class="product__description">
                Идеальное соотношение цены и качества, чтобы удовлетворить требования самых экономных - без ущерба
                для производительности и функциональности, необходимые в розничной торговле.
            </p>
            ...
            <div class="row row_middle product__bottom">
                ...
                <div class="col-auto">
                    <button type="button" class="button-product-buy" data-open-modal="#equipment-modal" data-type="PRODUCT_0002"
                            data-caption="Купить товар: Сканер штрих-кодов Zebra DS2200">Купить</button>
                </div>
            </div>
        </div>
    </div>
...
@section('table')
    <table>
        ...
        <tr><td>Вид сканера</td><td>Лазерный</td></tr>
        <tr><td>Скорость сканирования</td><td>100 скан/с</td></tr>
        <tr><td>Дальность сканирования</td><td>420 мм</td></tr>
        <tr><td>Индикация</td><td>Звуковая индикация</td></tr>
        <tr><td>Ударопрочность при падении</td><td>Падение с высоты 1,5 м</td></tr>
        <tr><th colspan="2">Габариты</th></tr>
        <tr><td>Размеры</td><td>152 x 60,4 x 80,5 мм</td></tr>
        <tr><td>Вес</td><td>146 г</td></tr>
    </table>
@endsection
