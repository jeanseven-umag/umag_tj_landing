    ...
    <div class="container sides-padding-40">
        <div class="row col-50 col-mob-100">
            ...
            <span class="product__description">
                POS UMAG T310 - ором ва ғуборногузар, бо тарҳи оддӣ ва муътадил. Барои савдои чакана беҳтарин аст.
            </span>
            ...
            <div class="row row_middle product__bottom">
                ...
                <div class="col-auto">
                    ...
                    <button type="button" class="button-product-buy" data-open-modal="#equipment-modal" data-type="PRODUCT_0001" data-caption="Харидани маҳсулот: POS-моноблок UMAG T310">Харидан</button>
                </div>
            </div>
        </div>
    </div>
...
@section('table')
    <table>
        ...
        <tr><td>Хотира</td><td>2 ГБ DDR3, то 8 ГБ васеъшаванда</td></tr>
        <tr><td>Намоишгар</td><td>15,6" TFT LCD, қарори 1024 x 768, 1366 x 768</td></tr>
        <tr><td>Панели сенсорӣ</td><td>Навъи резистивӣ, интерфейси USB</td></tr>
        <tr><td>Дастгоҳи нигоҳдории маълумот</td><td>Диски сахти SATA SSD, 32 ГБ</td></tr>
        <tr><td>Вариантҳои насб</td><td>Мизи корӣ</td></tr>
        <tr><td>Дастгирии системаҳои оператсионӣ</td><td>Windows XP, Windows 7</td></tr>
        <tr><td>Портҳои воридот/баромад</td><td>1x VGA, 1x RS-232 (3x DB9), 6x USB, 1x Ethernet, 1x баромади аудио, 1x микрофон</td></tr>
        <tr><td>Ранги корпус</td><td>Сиёҳ</td></tr>
        <tr><td>Кортхонандаи магнитӣ</td><td>Ихтиёрӣ: кортхонандаи магнитӣ барои 3 роҳ</td></tr>
        <tr><td>Истеҳсолкунанда</td><td>Elanda (Чин)</td></tr>
    </table>
@endsection
