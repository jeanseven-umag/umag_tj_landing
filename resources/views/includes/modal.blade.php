...
{{--        <p class="modal-title">Истифодабарандаи мӯҳтарам!</p>--}}
{{--        <button class="close" title="Закрыть"></button>--}}
{{--        <div class="modal-line"></div>--}}
{{--        <p class="modal-description">— Мо ба шумо хабар медихем, ки барои ҳамаи мизоҷони нармафзори Umag аз 17 октябри соли 2022 тарофаи "Ягона" эътибор дорад, ки арзиши хироҷи литсензия барои ҳуқуқи истифодаи Барнома инҳо хоҳад буд:--}}
{{--            <br/>- Арзиши 1-ой савдои нуқта – <b>4 000 тг / моҳ</b>--}}
{{--            <br/>- Арзиши 1-ум корманд – <b>1 500 тг / моҳ</b>--}}
{{--            <br/>- Арзиши 1-ой касса – <b>2 000 тг / моҳ</b>--}}
{{--        </p>--}}
{{--        <a href="/ceny" class="modal-btn">Ба обуна гузаштан</a>--}}
{{--    </div>--}}
{{--</div>--}}
