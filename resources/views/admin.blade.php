                ...
                <div class="card-body">
                    ...
                    <form id="addItem" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input name="eq_name" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Номи молро ворид кунед">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput2">Нарх</label>
                            <input name="eq_price" type="text" class="form-control" id="exampleFormControlInput2" placeholder="Нархро ворид кунед">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput3">Тахфиф агар бошад</label>
                            <input name="eq_sale" type="text`" class="form-control" id="exampleFormControlInput3" placeholder="Номи молро ворид кунед">
                            <small id="emailHelp" class="form-text text-muted">Агар тахфиф надошта бошад, майдонро холӣ гузоред</small>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput4">url-и мол</label>
                            <input name="eq_url" type="text" class="form-control" id="exampleFormControlInput4" placeholder="url-ро ворид кунед">
                            <small id="emailHelp" class="form-text text-muted">Барои мол url фикр кунед</small>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput5">Видео-шарҳ</label>
                            <input name="eq_video" type="text" class="form-control" id="exampleFormControlInput5" placeholder="id-и видео ворид кунед">
                        ...
                        <div class="form-group">
                            ...
                            <input name="eq_image" type="text" class="form-control" id="exampleFormControlInput6" placeholder="Номи тасвир">
                            <small id="emailHelp" class="form-text text-muted">ID-и видео дар youtube</small>
                        </div>
                        <div class="form-group">
