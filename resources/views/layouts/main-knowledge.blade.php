...
<head>
    ...
    <!-- Amplitude -->
    <script src="https://cdn.amplitude.com/script/6af3f67dad0f8b84ad163dfa50edda07.js"></script>
    <script>window.amplitude.add(window.sessionReplay.plugin({sampleRate: 1}));window.amplitude.init('6af3f67dad0f8b84ad163dfa50edda07', {"fetchRemoteConfig":true,"autocapture":true});</script>
</head>
<body style="visibility: hidden;">
    ...
    @if(!isset($side))
        <?php $side = 'mag';?>
    @endif
    @include('includes.header-knowledge')
        @yield('content')
